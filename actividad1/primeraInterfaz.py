...
datos=ttk.Frame(tab1, padding="10 20 10 20", relief="groove")
...
'''style'''
style=ttk.Style()
style.configure("menuStyle", background='blue')
...
ttk.Label(datos, text="apellido").grid(column=4, row=0)
...
normal.grid(column=1,row=0,padx=15, sticky=W)
